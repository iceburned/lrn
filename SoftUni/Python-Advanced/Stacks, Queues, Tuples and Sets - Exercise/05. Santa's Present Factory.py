# spageti code, but gives 100/100
...
#             if materials[-1] == 0 or self.magic[0] == 0:
#                 self.zero_or_one()
#                 continue
...
#         if self.materials[-1] == 0 and self.magic[0] == 0:
#             self.materials.pop()
#             self.magic.popleft()
#         elif self.magic[0] == 0:
#             self.magic.popleft()
#         elif self.materials[-1] == 0:
#             self.materials.pop()
#
#     def flag_mark(self):
...
#         if self.materials:
#             print(f"Materials left: {(', '.join(map(str, reversed(self.materials))))}")
#         if self.magic:
#             print(f"Magic left: {', '.join(map(str, self.magic))}")
#         for k, v in sorted(self.temp_box.items()):
#             print(f"{k}: {v}")
#
#
